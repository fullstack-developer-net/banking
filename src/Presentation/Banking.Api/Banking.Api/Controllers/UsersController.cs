...
namespace Banking.Api.Controllers
{
    ...
    public class UsersController(IMediator mediator, IOptions<JwtSettings> options, IUnitOfWork unitOfWork, UserManager<User> userManager, RoleManager<Role> roleManager) : BaseApiController
    {
        [HttpPost("login")]
